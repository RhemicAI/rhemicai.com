  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2.5 px-6 py-3 text-sm font-medium rounded-full bg-[var(--ink)] text-[var(--bg)] hover:bg-[var(--pulse)] transition-colors duration-200"
      >
        <svg
          width="16"
          height="16"
