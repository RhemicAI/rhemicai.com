    ...
    <section className="rhemic-grid-bg relative min-h-screen overflow-hidden px-[clamp(20px,4vw,64px)] pb-16 pt-28 md:pt-36">
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-9rem)] max-w-[1280px] items-center gap-10 lg:grid-cols-[0.92fr_0.98fr] lg:gap-24 xl:gap-28">
        <div className="min-w-0">
          ...
          <h1 className="hero-enter-title max-w-[720px] font-display text-[clamp(3.05rem,6.25vw,5.45rem)] font-medium leading-[0.95] tracking-normal text-[var(--ink)]">
            Turn med spa searches and missed calls into{' '}
            <span className="hero-proof-word block">booked consults.</span>
          </h1>
          ...
          <div className="hero-enter-copy mt-8 flex flex-col gap-3 sm:flex-row">
            <CalBookingLink
