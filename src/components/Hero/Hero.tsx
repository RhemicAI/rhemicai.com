    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-12 overflow-x-hidden">
      <div className="relative z-10 text-center max-w-5xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center gap-3">
          <p className="text-[10px] tracking-[0.2em] uppercase text-[var(--text-muted)] font-body">
            Optimized for
          </p>
          <div className="flex items-center justify-center gap-8 text-[var(--text-tertiary)]">
            {/* OpenAI / ChatGPT */}
            <span className="flex flex-col items-center gap-1.5">
              <svg width="18" height="18" viewBox="-1 -.1 949.1 959.8" fill="currentColor" className="opacity-60">
              ...
              <span className="text-[9px] tracking-wider uppercase text-[var(--text-muted)] font-body">ChatGPT</span>
            </span>
            {/* Anthropic / Claude */}
            <span className="flex flex-col items-center gap-1.5">
              <svg width="18" height="18" viewBox="0 -.01 39.5 39.53" fill="currentColor" className="opacity-60">
              ...
              <span className="text-[9px] tracking-wider uppercase text-[var(--text-muted)] font-body">Claude</span>
            </span>
            {/* Perplexity */}
            <span className="flex flex-col items-center gap-1.5">
              <svg width="18" height="18" viewBox="1.5 0 21 24" fill="currentColor" fillRule="evenodd" className="opacity-60">
                <path d="M19.785 0v7.272H22.5V17.62h-2.935V24l-7.037-6.194v6.145h-1.091v-6.152L4.392 24v-6.465H1.5V7.188h2.884V0l7.053 6.494V.19h1.09v6.49L19.786 0zm-7.257 9.044v7.319l5.946 5.234V14.44l-5.946-5.397zm-1.099-.08l-5.946 5.398v7.235l5.946-5.234V8.965zm8.136 7.58h1.844V8.349H13.46l6.105 5.54v2.655zm-8.982-8.28H2.59v8.195h1.8v-2.576l6.192-5.62zM5.475 2.476v4.71h5.115l-5.115-4.71zm13.219 0l-5.115 4.71h5.115v-4.71z"/>
              </svg>
              <span className="text-[9px] tracking-wider uppercase text-[var(--text-muted)] font-body">Perplexity</span>
            </span>
            {/* Google Gemini */}
            <span className="flex flex-col items-center gap-1.5">
              <svg width="18" height="18" viewBox="0 0 28.01 28" className="opacity-60">
                <defs>
                  <radialGradient id="hero-gemini-grad" cx="-576.08" cy="491.7" gradientTransform="matrix(28.2302 9.54441 76.4642 -226.16369 -21336.18 116711.38)" gradientUnits="userSpaceOnUse" r="1">
                    <stop offset=".07" stopColor="#9168c0"/>
                    <stop offset=".34" stopColor="#5684d1"/>
                    <stop offset=".67" stopColor="#1ba1e3"/>
                  </radialGradient>
                </defs>
                <path d="M14 28c0-1.94-.37-3.76-1.12-5.46-.72-1.7-1.72-3.19-2.98-4.45s-2.74-2.25-4.44-2.97C3.76 14.37 1.94 14 0 14c1.94 0 3.76-.36 5.46-1.09 1.7-.75 3.19-1.75 4.44-3.01 1.26-1.26 2.25-2.74 2.98-4.44C13.63 3.76 14 1.94 14 0c0 1.94.36 3.76 1.09 5.46.75 1.7 1.75 3.19 3.01 4.44 1.26 1.26 2.74 2.26 4.45 3.01 1.7.72 3.52 1.09 5.46 1.09-1.94 0-3.76.37-5.46 1.12-1.7.72-3.19 1.71-4.45 2.97s-2.26 2.74-3.01 4.45A13.86 13.86 0 0 0 14 28z" fill="url(#hero-gemini-grad)"/>
              </svg>
              <span className="text-[9px] tracking-wider uppercase text-[var(--text-muted)] font-body">Gemini</span>
            </span>
          </div>
